...
__kernel void k_morse_buck_lj_dsf(const __global numtyp4 *restrict x_,
  ...
  if (ii<inum) {
    ...
    for ( ; nbor<nbor_end; nbor+=n_stride) {
      ...
      if (rsq<lj1[mtype].w) {
        ...
        numtyp dexp, dm, forcemorse, forcebuck;
        ...
        force = (force_lj + forcecoul + forcebuck) * r2inv + forcemorse;
        ...
        if (eflag>0) {
          ...
          if (rsq < lj1[mtype].z) {
            ...
            energy+=e*factor_lj;
            e=coeff2[mtype].x*rexp - coeff2[mtype].y*r6inv;
            energy+=factor_lj*e;
...
__kernel void k_morse_buck_lj_dsf_fast(const __global numtyp4 *restrict x_,
